...
<body>
    ...
    <h1 align="center">AWS and DevOps Training Center - Very Good Training center for DevOps with AWS, Python & AWS Solution Architect & Terraform in Bangalore India. Teaching Real Time Scenarios</h1>
    <hr><br>
